class Test{
	public static void main(String[] args){
		...
		ATM atm = new Bank(3.5,10); //The reference here is ATM and not Bank even though it can be done using Bank reference, but contextually these methods belong to the ATM and the Bank is just the implementer
